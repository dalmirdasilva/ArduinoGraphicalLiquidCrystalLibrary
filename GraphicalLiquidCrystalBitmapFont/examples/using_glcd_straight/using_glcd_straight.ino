...
void setup() {
    ...
    ExternalEepromSeekableInputStream eInputStream(&mappedEeprom);
    ExternalEepromOutputStream eOutputStream(&mappedEeprom);
    ...
    GraphicalLiquidCrystalBitmapFont bitmapFont(&eInputStream);
    GraphicalLiquidCrystalText text(&glcd, &bitmapFont, &graphicState);

    Serial.println("writing..");
    for (int k = 0; k < 482; k++) {
        eOutputStream.write(font[k]);
    }
    Serial.println("done");
    ...
    for (int k = 0; k < 482; k++) {
        Serial.println(eInputStream.read(), HEX);
    }
    Serial.println("done");
    ...
    delay(2000);
    drawer.circle(10, 50, 10);
    delay(2000);
    drawer.circle(30, 10, 4);
    /*
  graphicState.setColor(GraphicalLiquidCrystal::COLOR_BLACK);
  glcd.screen(GraphicalLiquidCrystal::COLOR_WHITE);
  text.printString (10, 10, 100, 40, (const unsigned char *)"Cintia safada! ", 100);
  delay(3000);
  graphicState.setColor(GraphicalLiquidCrystal::COLOR_WHITE);
  glcd.screen(GraphicalLiquidCrystal::COLOR_BLACK);
  text.printString (10, 10, 100, 40, (const unsigned char *)"Da bundinha pintada!", 100);
  delay(3000);*/
}
